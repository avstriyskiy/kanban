            ...
            <div class="card">
                            ...
                            <div class="col">
                                @if (Task::isDeadline($task->deadline) == 'today')
                                            ...
                                            <div class="text-dark">
                                                @else
                                                    <div class="text-bg-danger">
                                                        @endif
                                                        <h5><b>{{ Task::dateFormat($task->deadline) }}</b></h5>
                                                    </div>
                                            </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <h5><b>{{ Task::STATUSES[$task->status] }}</b></h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <form method="POST" action="{{ route('document.store', $task) }}"
                                                ...
                                                @endif
                                                <button type="submit" class="btn btn-outline-secondary">Добавить
                                                </button>
                                            </form>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row mt-2">
                                                <form method="POST" action="{{ route('tasks.delete', $task) }}">
                                                    ...
                                                    <button type="submit" class="btn btn-outline-secondary">
                                                        <input type="hidden" name="doc" value="{{ $file->id }}"
                                                               class="w-0">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <a class="btn btn-outline-dark" data-bs-toggle="collapse" href="#add_comment"
                                   role="button" aria-expanded="false">Добавить комментарий</a>
                                    ...
                                    <div class="card card-body mt-2">
                                        <form method="POST" action="{{ route('comments.create', $task) }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="body" class="form-control" id="comment_body"
                                                          rows="3"></textarea>
                                    ...
                                    @foreach($comments as $comment)
                                        <div class="card mt-3">
                                            <div class="card-body">
                                                ...
                                                <div class="row gx">
                                                    <div class="col">
                                                        <p class="mb-0 mt-3">{{ \Auth::user()->name }}</p>
                                                    </div>
                                                    <div class="col">
